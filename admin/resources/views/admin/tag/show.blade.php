            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/tag/' . $tag->id . '/edit') }}" title="Edit Tag"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                        <form method="POST" action="{{ url('admin/tag' . '/' . $tag->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
