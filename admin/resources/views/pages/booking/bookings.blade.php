      ...
      <div class="row">
        <div class="col-xl-3 mb-5 sticky-top">
          <div class="admin-nav nav flex-column nav-pills" aria-orientation="vertical">
            ...
            <a class="nav-link transition-link" href="{{route('personal.review' , ['id' => $user->id])}}"> <i class="fas fa-star mr-2"></i>My Reviews</a><a class="nav-link transition-link" href="admin-pass-change.html"> <i class="fas fa-lock mr-2"></i>Change my Password</a></div>
        </div>
