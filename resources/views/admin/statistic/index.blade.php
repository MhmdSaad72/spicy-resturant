    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ url('/admin/statistic/create') }}" class="btn btn-success btn-sm" title="Add New Statistic">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/admin/statistic') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $statistic->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
