<header class="header bg-pattern">
    ...
    <div class="container d-flex justify-content-between align-items-center">
      <!-- Hotline button--><a class="d-flex align-items-center reset-anchor" href="tel:+29870988764">
        ...
        <div class="ml-2 d-none d-lg-block">
          ...
          <h6 class="line-height-sm mb-0">987 098 8764</h6>
        </div></a>
      <!-- Navabr brand--><a class="navbar-brand m-0 transition-link" href="index.html"><img src="img/logo-footer-default.svg" alt="Italiano Restaurant" width="145"></a>
  ...
  <nav class="navbar navbar-expand-lg navbar-light nav-bottom" id="navBottom">
    <div class="container py-2 position-relative px-3 bg-dark">
      ...
      <!-- Navabr brand--><a class="navbar-brand d-none position-absolute" href="index.html"><img src="img/logo-footer-default.svg" alt="Italiano Restaurant" width="100"></a>
      <!-- Navbar menu-->
