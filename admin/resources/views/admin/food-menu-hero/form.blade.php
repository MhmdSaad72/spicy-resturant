...
<div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="content" type="textarea" id="content" >{{ isset($foodmenu->content) ? $foodmenu->content : old('content')}}</textarea>
...
<div class="form-group">
    ...
    <a class="btn btn-warning" href="{{ route('food-menu.index') }}" title="Back"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
</div>
